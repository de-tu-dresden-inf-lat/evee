...
import de.tu_dresden.inf.lat.evee.forgettingBasedProofs.tools.{SearchTreeProgressTracker, TidyForgettingBasedProofs}
import de.tu_dresden.inf.lat.evee.forgettingBasedProofs.{Constants, ForgettingBasedProofGenerator}
