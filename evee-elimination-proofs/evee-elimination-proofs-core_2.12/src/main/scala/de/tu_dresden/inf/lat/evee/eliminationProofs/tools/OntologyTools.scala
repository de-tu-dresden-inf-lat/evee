...
object OntologyTools {
  ...
  def createOntology(axioms: Iterable[OWLAxiom], manager: OWLOntologyManager): OWLOntology = {
    var o = manager.createOntology()
    axioms.foreach(manager.addAxiom(o, _))
    o
  }
