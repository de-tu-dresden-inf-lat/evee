...
import de.tu_dresden.inf.lat.evee.forgettingBasedProofs.minimal.{ApproximateProofMeasureAxiomSizeSum, ProofEvaluatorInferenceNumber, ApproximateProofMeasureInferenceNumber, MinimalForgettingBasedProofGenerator, SymbolMinimalForgettingBasedProofGenerator}
