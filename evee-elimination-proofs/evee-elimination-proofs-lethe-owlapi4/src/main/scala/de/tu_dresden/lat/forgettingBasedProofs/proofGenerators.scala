...
import de.tu_dresden.inf.lat.forgettingBasedProofs.minimal.{ApproximateProofMeasureAxiomSizeSum, ProofEvaluatorInferenceNumber, ApproximateProofMeasureInferenceNumber, MinimalForgettingBasedProofGenerator, SymbolMinimalForgettingBasedProofGenerator}
