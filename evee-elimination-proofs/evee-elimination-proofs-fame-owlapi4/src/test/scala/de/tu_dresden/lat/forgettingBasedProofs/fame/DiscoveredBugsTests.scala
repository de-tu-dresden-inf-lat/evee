package scala.de.tu_dresden.inf.lat.forgettingBasedProofs.fame

import de.tu_dresden.inf.lat.forgettingBasedProofs.{FameBasedHeuristicProofGenerator, FameBasedSizeMinimalProofGenerator, FameBasedSymbolMinimalProofGenerator, FameBasedWeightedSizeMinimalProofGenerator}
