...
import de.tu_dresden.inf.lat.forgettingBasedProofs.{LetheBasedALCHProofGenerator, LetheBasedALCHProofGeneratorSkippingSteps, LetheBasedSymbolMinimalProofGenerator}
...
import de.tu_dresden.inf.lat.proofs.interfaces.{IInference, ISimpleProofGenerator}
