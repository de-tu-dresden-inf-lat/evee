...
import de.tu_dresden.inf.lat.forgettingBasedProofs.tools.{SearchTreeProgressTracker, TidyForgettingBasedProofs}
import de.tu_dresden.inf.lat.forgettingBasedProofs.{Constants, ForgettingBasedProofGenerator}
...
import de.tu_dresden.inf.lat.proofs.interfaces._
