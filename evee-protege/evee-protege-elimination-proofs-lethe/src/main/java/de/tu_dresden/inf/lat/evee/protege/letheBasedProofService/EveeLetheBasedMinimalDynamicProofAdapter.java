...
public class EveeLetheBasedMinimalDynamicProofAdapter extends AbstractEveeSuboptimalDynamicProofAdapter {
    ...
    private final Logger logger = LoggerFactory.getLogger(EveeLetheBasedMinimalDynamicProofAdapter.class);

    public EveeLetheBasedMinimalDynamicProofAdapter(MinimalForgettingBasedProofGenerator iProofGen, AbstractEveeEliminationProofPreferencesManager proofPreferencesManager, EveeDynamicSuboptimalProofLoadingUI uiWindow) {
