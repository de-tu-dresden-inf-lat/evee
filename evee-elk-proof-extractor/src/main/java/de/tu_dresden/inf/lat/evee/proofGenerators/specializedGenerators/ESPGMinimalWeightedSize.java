 ...
 *
 */
public class ESPGMinimalWeightedSize extends ELKSpecializedProofGenerator {

	public ESPGMinimalWeightedSize() {
		super();
	}

	@Override
	public IProof<OWLAxiom> getProof(OWLAxiom axiom) throws ProofGenerationFailedException {
		return this.generator.getTreeProof(axiom, ProofType.MinimalWeightedTreeSize, null);
	}
